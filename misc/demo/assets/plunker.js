      ...
      var indexContent = function (content, version) {
        return '<!doctype html>\n' +
          ...
          '    <script src="http://ajax.googleapis.com/ajax/libs/angularjs/'+ngVersion+'/angular.js"></script>\n' +
            '    <script src="https://github.com/angular-ui/bootstrap/blob/gh-pages/ui-bootstrap-tpls-0.9.0.min.js"></script>\n' +
            '    <script src="http://angular-ally.github.io/angular-ally-'+version+'.js"></script>\n' +
